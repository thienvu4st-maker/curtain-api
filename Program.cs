...
// --- 5. Database Schema Migration (Executes Raw DDL FIRST) ---
using (var scope = app.Services.CreateScope())
{
    var dbContext = scope.ServiceProvider.GetRequiredService<AppDbContext>();

    // Execute Raw DDL FIRST to ensure columns & tables exist before EF Core model validation
    var preMigrationSql = @"
        ...
        -- 2. Add missing columns dynamically if Supabase table was legacy
        ...
        -- 3. Ensure CategoryGroups table exists
        ...
        -- 5. Drop & recreate cleanly for fresh seed
        DROP TABLE IF EXISTS ""Products"", ""Categories"", ""CategoryGroups"" CASCADE;
        ...
        -- 6. Seed Category Groups (Chuyên Đề)
        ...
        -- 9. Synchronize PostgreSQL IDENTITY Sequences
    ...
    try
    {
        dbContext.Database.ExecuteSqlRaw(preMigrationSql);
    }
    catch (Exception ex)
    {
