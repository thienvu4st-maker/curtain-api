...
// --- 5. Guaranteed Schema Migration ---
using (var scope = app.Services.CreateScope())
{
    var dbContext = scope.ServiceProvider.GetRequiredService<AppDbContext>();

    // 1. Mandatory ALTER TABLE execution (Guarantees columns exist regardless of legacy state)
    try
    {
    ...
    var migrationSql = @"
        ...
        -- Seed Category Groups (Chuyên Đề)
        ...
        -- Seed Categories linked to CategoryGroups
